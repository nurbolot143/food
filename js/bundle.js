...
function calc() {
  ...
  localStorage.getItem("sex") ? sex = localStorage.getItem("sex") : (sex = "female", localStorage.setItem("sex", "femal"));
  ...
  function initLocalSettings(selector, activeClass) {
    ...
    elements.forEach(function (elem) {
      ...
      elem.getAttribute("id") === localStorage.getItem("sex") && elem.classList.add(activeClass);
      elem.getAttribute("data-ratio") === localStorage.getItem("ratio") && elem.classList.add(activeClass);
    });
  }
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostDate(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postDate)("http://localhost:3000/requests", json).then(function (data) {
        console.log(data);
...
function modal(triggerSecector, modalSelector, modalTimerId) {
  //Modal
  var modal = document.querySelector(modalSelector);
  var modalTrigger = document.querySelectorAll(triggerSecector);
...
function slider(_ref) {
  ...
  slidesField.style.cssText = "\n  width: ".concat(100 * slides.length, "%;\n  display: flex;\n  transition: 0.5s all;\n");
